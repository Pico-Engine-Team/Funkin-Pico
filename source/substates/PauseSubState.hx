...
// Pico Engine and By PlusEngine and Psych Engine
import lucas.states.funkin.scripts.backend.LocaleUtils;
...
class PauseSubState extends MusicBeatSubstate
{
	...
	var dateTimeText:FlxText; // Pico Engine and By PlusEngine
	...
	override function create()
	{
		...
		var levelInfo:FlxText = new FlxText(20, 15, 0, Language.getPhrase("playing_song", "Now Playing: {1}", [PlayState.SONG.song]), 32);
