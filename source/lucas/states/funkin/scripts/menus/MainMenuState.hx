...
{
	public static var PicoVersion:String = '2.26.5'; // This is also used for Discord RPC + base game of mod
		...
		if (!selectedSomethin)
		{
			...
			if (controls.ACCEPT || (FlxG.mouse.justPressed && allowMouse))
			{
				...
				FlxFlicker.flicker(item, 1, 0.06, false, false, function(flick:FlxFlicker)
				{
					...
					{
						case 'story_mode':
							MusicBeatState.switchState(new lucas.states.funkin.scripts.modes.StoryMenuState());
						case 'freeplay':
							MusicBeatState.switchState(new lucas.states.funkin.scripts.menus.FreeplayState());
						case 'credits':
