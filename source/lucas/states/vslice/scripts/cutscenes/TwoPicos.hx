package lucas.states.vslice.scripts.cutscenes;
...
import lucas.states.vslice.scripts.objects.PicoDopplegangerSprite;
import lucas.funkin.stages.vslice.erect.PhillyTrainErect;
